...
public class ModItems {
    ...
    public static final RegistryObject<ArmorItem> CELESTIAL_SILVER_HELMET = Registration.ITEMS.register("celestial_silver_helmet", () -> new ModArmor(CELESTIAL_SILVER_ARMOR_MATERIAL, EquipmentSlotType.HEAD));
    public static final RegistryObject<ArmorItem> CELESTIAL_SILVER_CHESTPLATE = Registration.ITEMS.register("celestial_silver_chestplate", () -> new ModArmor(CELESTIAL_SILVER_ARMOR_MATERIAL, EquipmentSlotType.CHEST));
    public static final RegistryObject<ArmorItem> CELESTIAL_SILVER_LEGGINGS = Registration.ITEMS.register("celestial_silver_leggings", () -> new ModArmor(CELESTIAL_SILVER_ARMOR_MATERIAL, EquipmentSlotType.LEGS));
    public static final RegistryObject<ArmorItem> CELESTIAL_SILVER_BOOTS = Registration.ITEMS.register("celestial_silver_boots", () -> new ModArmor(CELESTIAL_SILVER_ARMOR_MATERIAL, EquipmentSlotType.FEET));
